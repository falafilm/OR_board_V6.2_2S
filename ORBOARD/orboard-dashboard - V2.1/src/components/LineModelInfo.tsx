  ...
  return (
    <Card className="flex-1" radius="none" shadow="none">
      <CardBody className="grid grid-cols-[200px_1fr] grid-rows-2 p-0 h-full">
        <div
          className={`${BLACK_LABEL_CLASS} border-b-2 border-r-2 border-gray-800`}
        >
          LINE
        </div>
        <div className="flex items-center justify-center text-8xl font-bold border-b-2 border-gray-800">
          {line}
        </div>
        <div className={`${BLACK_LABEL_CLASS} border-2 border-gray-800`}>
          MODEL
        </div>
        <div className="flex items-center justify-center text-8xl font-bold border-b-2 border-gray-800">
          {model}
